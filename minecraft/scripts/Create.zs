...
<recipetype:create:compacting>.addRecipe("great_transmutation", <constant:create:heat_condition:superheated>, [<item:create:chromatic_compound> % 25], [<item:hexcasting:creative_unlocker>, <item:createaddition:electrum_ingot> * 4, <item:createaddition:diamond_grit> * 4, <item:born_in_chaos_v1:phantom_powder> * 4, <item:botania:pixie_dust> * 4, <item:minecraft:redstone> * 4, <item:netherexp:banshee_powder> * 4, <item:enigmaticlegacy:astral_dust> * 4, <item:create:powdered_obsidian> * 4], [<fluid:minecraft:lava> * 500, <fluid:create_enchantment_industry:hyper_experience> * 500], 16000);
import mods.create.CrushingManager;
<recipetype:create:crushing>.addRecipe("creation_of_such_matter", [<item:enigmaticlegacy:the_cube>, <item:enigmaticlegacy:eye_of_nebula> % 0.1, <item:enigmaticlegacy:blazing_core> % 0.1, <item:enigmaticlegacy:void_pearl> % 0.1, <item:enigmaticlegacy:ocean_stone> % 0.1, <item:enigmaticlegacy:angel_blessing> % 0.1, <item:enigmaticlegacy:golem_heart> % 0.1, <item:enigmaticaddons:illusion_lantern> % 0.1, <item:enigmaticlegacy:unwitnessed_amulet> % 0.1, <item:enigmaticlegacy:cursed_ring> % 0.1, <item:enigmaticlegacy:void_stone> % 0.1, <item:enigmaticlegacy:astral_fruit> % 0.1, <item:enigmaticlegacy:ichor_bottle> % 0.1, <item:enigmaticlegacy:redemption_potion> % 0.1, <item:enigmaticlegacy:unholy_grail> % 0.1, <item:enigmaticlegacy:enigmatic_eye> % 0.1, <item:enigmaticaddons:artificial_flower> % 0.1, <item:enigmaticaddons:void_tome> % 0.1, <item:enigmaticlegacy:forbidden_fruit> % 0.1, <item:enigmaticaddons:hell_blade_charm> % 0.1, <item:enigmaticaddons:antique_bag> % 0.1], <item:enigmaticlegacy:the_cube>, 400);
...
<recipetype:create:mixing>.addRecipe("crystal_growing", <constant:create:heat_condition:heated>, [<item:create_unbreakable:philolite> % 12.5], [<item:minecraft:quartz> * 3, <item:minecraft:amethyst_shard>], [<fluid:minecraft:water> * 250], 400);
...
<recipetype:create:mechanical_crafting>.addRecipe("elytra", <item:minecraft:elytra>, [[<item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>, <item:create:shaft>, <item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>], [<item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>, <item:create:precision_mechanism>, <item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>], [<item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>, <item:minecraft:totem_of_undying>, <item:minecraft:phantom_membrane>, <item:minecraft:phantom_membrane>], [<item:minecraft:air>, <item:minecraft:phantom_membrane>, <item:minecraft:air>, <item:minecraft:phantom_membrane>, <item:minecraft:air>]]);
