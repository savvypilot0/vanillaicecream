...
craftingTable.addShaped("totem_natural_enchantment", <item:minecraft:totem_of_undying> * 1, [
...
import crafttweaker.api.recipe.MirrorAxis;craftingTable.addShapedMirrored("lost_engine", MirrorAxis.ALL, <item:enigmaticaddons:lost_engine> * 1, [
[<item:create_unbreakable:luminarchy>, <item:immersive_aircraft:nether_engine>, <item:createdieselgenerators:engine_silencer>], 
[<item:immersive_aircraft:engine>, <item:ancient_forgemastery:remnant_artifact>, <item:createdieselgenerators:engine_piston>], 
[<item:createdieselgenerators:engine_turbocharger>, <item:immersive_aircraft:eco_engine>, <item:create_unbreakable:luminarchy>]]);
craftingTable.addShapeless("lost_listya", <item:enigmaticaddons:revival_leaf> * 1, 
[<item:botania:overgrowth_seed>]);
craftingTable.addShapeless("lost_listya1", <item:botania:overgrowth_seed> * 1, 
[<item:enigmaticaddons:revival_leaf>]);
craftingTable.addShapeless("lost_lyodic", <item:enigmaticaddons:forgotten_ice> * 1, 
[<item:mowziesmobs:ice_crystal>]);
craftingTable.addShapeless("lost_lyodic1", <item:mowziesmobs:ice_crystal> * 1, 
[<item:enigmaticaddons:forgotten_ice>]);
craftingTable.addShapeless("lost_serdece", <item:enigmaticaddons:earth_heart_fragment> * 8, 
[<item:enigmaticlegacy:earth_heart>]);
craftingTable.addShapeless("ihororor", <item:enigmaticaddons:ichor_droplet> * 2, 
[<item:enigmaticlegacy:ichor_bottle>.transformReplace(<item:minecraft:glass_bottle>)]);
craftingTable.addShapeless("splav3", <item:hexcasting:quenched_allay_shard> * 64, 
[<item:hexcasting:creative_unlocker>, <item:hexcasting:quenched_allay_shard>]);
craftingTable.addShapeless("splav2", <item:hexcasting:quenched_allay_shard> * 1, 
[<item:hexcasting:creative_unlocker>, <item:hexcasting:quenched_allay_shard>]);
craftingTable.addShapeless("splav1", <item:hexcasting:quenched_allay> * 64, 
[<item:hexcasting:creative_unlocker>, <item:hexcasting:quenched_allay>]);
craftingTable.addShapeless("splav0", <item:hexcasting:quenched_allay> * 1, 
[<item:hexcasting:creative_unlocker>, <item:hexcasting:quenched_allay>]);
import crafttweaker.api.recipe.SmithingRecipeManager;
import crafttweaker.api.item.IItemStack;
smithing.addTransformRecipe("blackjack", <item:netherexp:jackhammer_fist>, <item:cataclysm:sandstorm_in_a_bottle>, <item:netherexp:shotgun_fist>, <item:cataclysm:ancient_metal_ingot>);
import crafttweaker.api.recipe.MirrorAxis;craftingTable.addShapedMirrored("stormic", MirrorAxis.ALL, <item:cataclysm:essence_of_the_storm> * 1, [
[<item:minecraft:air>, <item:minecraft:air>, <item:createaddition:electrum_nugget>], 
[<item:minecraft:air>, <item:createaddition:electrum_nugget>, <item:minecraft:air>], 
[<item:createaddition:electrum_nugget>, <item:minecraft:air>, <item:minecraft:air>]]);
import crafttweaker.api.recipe.MirrorAxis;craftingTable.addShapedMirrored("lacrimblyat", MirrorAxis.ALL, <item:minecraft:air> * 0, [
[<item:minecraft:prismarine_crystals>, <item:minecraft:diamond>, <item:minecraft:air>], 
[<item:minecraft:ghast_tear>, <item:minecraft:prismarine_crystals>, <item:minecraft:air>], 
[<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>]]);
