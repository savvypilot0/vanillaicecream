...
[<item:mythicbotany:aura_ring_greatest>, <item:mythicbotany:mana_ring_greatest>.withTag({mana: 4000000}), <item:mythicbotany:aura_ring_greatest>], 
[<item:mythicbotany:mana_ring_greatest>.withTag({mana: 4000000}), <item:minecraft:structure_void>, <item:mythicbotany:mana_ring_greatest>.withTag({mana: 4000000})], 
[<item:mythicbotany:aura_ring_greatest>, <item:mythicbotany:mana_ring_greatest>.withTag({mana: 4000000}), <item:mythicbotany:aura_ring_greatest>]]);
...
[<item:minecraft:nether_star>, <item:create:blaze_cake>, <item:minecraft:nether_star>]]);
import crafttweaker.api.recipe.MirrorAxis;craftingTable.addShapedMirrored("infinitume_of_rotate", MirrorAxis.ALL, <item:create:creative_motor> * 1, [
[<item:minecraft:blue_ice>, <item:create:fluid_tank>, <item:create:fluid_tank>], 
[<item:minecraft:blue_ice>, <item:minecraft:structure_void>, <item:create:fluid_tank>], 
[<item:create:steam_engine>, <item:minecraft:blue_ice>, <item:create:fluid_tank>]]);
craftingTable.addShapeless("infinitume_of_liquid", <item:create:creative_fluid_tank> * 2, 
[<item:netherexp:ectoplasm_bucket>, <item:minecraft:dripstone_block>, <item:spelunkery:portal_fluid_bucket>, <item:create:fluid_tank>, <item:minecraft:structure_void>, <item:create:fluid_tank>, <item:minecraft:lava_bucket>, <item:spelunkery:spring_water_bucket>, <item:minecraft:milk_bucket>]);
...
[<item:hexcasting:creative_unlocker>, <item:create:creative_blaze_cake>, <item:botania:mana_tablet>]]);
craftingTable.addShapeless("infinitume_of_terra", <item:create:handheld_worldshaper>, 
[<item:create:creative_crate>.reuse(), <item:vs_clockwork:creative_gravitron>]);
